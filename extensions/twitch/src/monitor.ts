...
import type { ReplyPayload, SudoClawConfig } from "sudoclaw/plugin-sdk";
import { createReplyPrefixOptions } from "sudoclaw/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SudoClawConfig;
