...
## Using `openclaw.invoke` (Lobster → SudoClaw tools)

Some Lobster pipelines may include a `openclaw.invoke` step to call back into SudoClaw tools/plugins (for example: `gog` for Google Workspace, `gh` for GitHub, `message.send`, etc.).
