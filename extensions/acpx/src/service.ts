...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "sudoclaw/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: SudoClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: SudoClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
