...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "sudoclaw/plugin-sdk";
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredSudoClawTmpDir(), "msteams-mention-"));
