...
import { resolveChannelMediaMaxBytes, type SudoClawConfig } from "sudoclaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: SudoClawConfig; accountId?: string }): string[] {
