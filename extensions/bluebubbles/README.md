...
This directory contains the **BlueBubbles external channel plugin** for SudoClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `sudoclaw/plugin-sdk` helpers.
