...
import { fetchWithSsrFGuard, isWSL2Sync } from "sudoclaw/plugin-sdk";

const CLIENT_ID_KEYS = ["SUDOCLAW_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to SudoClaw.</p></body></html>",
        );
