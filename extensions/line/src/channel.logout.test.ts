import type { SudoClawConfig, PluginRuntime, ResolvedLineAccount } from "sudoclaw/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: SudoClawConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: SudoClawConfig; accountId: string }): Promise<{
