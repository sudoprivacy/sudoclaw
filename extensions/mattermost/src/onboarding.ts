import type { ChannelOnboardingAdapter, SudoClawConfig, WizardPrompter } from "sudoclaw/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "sudoclaw/plugin-sdk/account-id";
import {
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.sudoclaw.ai/channels/mattermost",
    ].join("\n"),
