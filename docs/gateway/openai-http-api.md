...
- `model: "sudoclaw:<agentId>"` (example: `"sudoclaw:main"`, `"sudoclaw:beta"`)
- `model: "agent:<agentId>"` (alias)

Or target a specific SudoClaw agent by header:

- `x-sudoclaw-agent-id: <agentId>` (default: `main`)

Advanced:

- `x-sudoclaw-session-key: <sessionKey>` to fully control session routing.
