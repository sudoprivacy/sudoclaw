...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up SudoClaw?](#whats-the-recommended-way-to-install-and-set-up-openclaw)
  ...
  - [How do I install SudoClaw on Linux?](#how-do-i-install-openclaw-on-linux)
  - [How do I install SudoClaw on a VPS?](#how-do-i-install-openclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask SudoClaw to update itself?](#can-i-ask-openclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run SudoClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different SudoClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run SudoClaw on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run SudoClaw in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is SudoClaw?](#what-is-openclaw)
  - [What is SudoClaw, in one paragraph?](#what-is-openclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for SudoClaw](#what-are-the-top-five-everyday-use-cases-for-openclaw)
  - [Can SudoClaw help with lead gen outreach ads and blogs for a SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can SudoClaw run tasks on a schedule or continuously in the background?](#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with SudoClaw saved locally?](#is-all-data-used-with-openclaw-saved-locally)
  - [Where does SudoClaw store its data?](#where-does-openclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall SudoClaw?](#how-do-i-completely-uninstall-openclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the SudoClaw browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two SudoClaw instances talk to each other (local + VPS)?](#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does SudoClaw load environment variables?](#how-does-openclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of SudoClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset SudoClaw but keep it installed?](#how-do-i-completely-reset-openclaw-but-keep-it-installed)
  ...
  - [Why doesn't SudoClaw reply in a group?](#why-doesnt-openclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do SudoClaw, Flawd, and Krill use for models?](#what-do-openclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run SudoClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart SudoClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose SudoClaw to inbound DMs?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/sudoclaw/openclaw-*.log | head -1)"
   ```
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.sudoclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.sudoclaw/sudoclaw.json`). Precedence is `<workspace>/skills` > `~/.sudoclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.sudoclaw/sudoclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.sudoclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which SudoClaw treats as `<workspace>/skills`.
...
SudoClaw reads an optional **JSON5** config from `$SUDOCLAW_CONFIG_PATH` (default: `~/.sudoclaw/sudoclaw.json`):
...
Profiles also suffix service names (`ai.openclaw.<profile>`; legacy `com.openclaw.*`, `sudoclaw-gateway-<profile>.service`, `SudoClaw Gateway (<profile>)`).
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [SudoClaw assistant setup](/start/openclaw) and [Agent send](/tools/agent-send).
