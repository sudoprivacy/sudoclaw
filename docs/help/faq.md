---
summary: "Frequently asked questions about SudoClaw setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up SudoClaw?](#whats-the-recommended-way-to-install-and-set-up-sudoclaw)
  ...
  - [I can't access docs.sudoclaw.ai (SSL error). What now?](#i-cant-access-docssudoclawai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or sudoclaw not recognized](#windows-install-says-git-not-found-or-sudoclaw-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install SudoClaw on Linux?](#how-do-i-install-sudoclaw-on-linux)
  - [How do I install SudoClaw on a VPS?](#how-do-i-install-sudoclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask SudoClaw to update itself?](#can-i-ask-sudoclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run SudoClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-sudoclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different SudoClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-sudoclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run SudoClaw on a dedicated machine?](#how-important-is-it-to-run-sudoclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run SudoClaw in a VM and what are the requirements](#can-i-run-sudoclaw-in-a-vm-and-what-are-the-requirements)
- [What is SudoClaw?](#what-is-sudoclaw)
  - [What is SudoClaw, in one paragraph?](#what-is-sudoclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for SudoClaw](#what-are-the-top-five-everyday-use-cases-for-sudoclaw)
  - [Can SudoClaw help with lead gen outreach ads and blogs for a SaaS](#can-sudoclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can SudoClaw run tasks on a schedule or continuously in the background?](#can-sudoclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with SudoClaw saved locally?](#is-all-data-used-with-sudoclaw-saved-locally)
  - [Where does SudoClaw store its data?](#where-does-sudoclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall SudoClaw?](#how-do-i-completely-uninstall-sudoclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the SudoClaw browser run headless?](#can-the-sudoclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two SudoClaw instances talk to each other (local + VPS)?](#can-two-sudoclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does SudoClaw load environment variables?](#how-does-sudoclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of SudoClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-sudoclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset SudoClaw but keep it installed?](#how-do-i-completely-reset-sudoclaw-but-keep-it-installed)
  ...
  - [Why doesn't SudoClaw reply in a group?](#why-doesnt-sudoclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do SudoClaw, Flawd, and Krill use for models?](#what-do-sudoclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `sudoclaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-sudoclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `sudoclaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-sudoclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run SudoClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-sudoclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart SudoClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-sudoclaw)
  ...
  - [ELI5: `sudoclaw gateway restart` vs `sudoclaw gateway`](#eli5-sudoclaw-gateway-restart-vs-sudoclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose SudoClaw to inbound DMs?](#is-it-safe-to-expose-sudoclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/sudoprivacy/sudoclaw-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   sudoclaw health --verbose   # shows the target URL + config path on errors
   ```
...
This installs SudoClaw **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/sudoprivacy/sudoclaw/issues](https://github.com/sudoprivacy/sudoclaw/issues)
[https://github.com/sudoprivacy/sudoclaw/pulls](https://github.com/sudoprivacy/sudoclaw/pulls)
...
- `sudoclaw status`: quick snapshot of gateway/agent health + basic config.
- `sudoclaw models status`: checks provider auth + model availability.
- `sudoclaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `sudoclaw status --all`, `sudoclaw logs --follow`,
`sudoclaw gateway status`, `sudoclaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up SudoClaw
...
If you don't have a global install yet, run it via `pnpm sudoclaw onboard`.
...
- Retrieve it from the gateway host: `sudoclaw config get gateway.auth.token` (or generate one: `sudoclaw doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `sudoclaw gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `sudoclaw gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install SudoClaw on the new machine.
2. Copy `$SUDOCLAW_STATE_DIR` (default: `~/.sudoclaw`) from the old machine.
3. Copy your workspace (default: `~/.sudoclaw/workspace`).
...
under `~/.sudoclaw/` (for example `~/.sudoclaw/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-sudoclaw-store-its-data),
...
[https://github.com/sudoprivacy/sudoclaw/blob/main/CHANGELOG.md](https://github.com/sudoprivacy/sudoclaw/blob/main/CHANGELOG.md)
...
detail: [Troubleshooting](/help/troubleshooting#docssudoclawai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/sudoprivacy/sudoclaw/tree/main/docs](https://github.com/sudoprivacy/sudoclaw/tree/main/docs)
...
### Windows install says git not found or sudoclaw not recognized
...
**2) sudoclaw is not recognized after install**
...
### How do I install SudoClaw on Linux
...
### How do I install SudoClaw on a VPS
...
### Can I ask SudoClaw to update itself
...
sudoclaw update --channel stable|beta|dev
sudoclaw update --tag <dist-tag|version>
...
```bash
sudoclaw update --yes --no-restart
sudoclaw gateway restart
```
...
`sudoclaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run SudoClaw with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `sudoclaw models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `sudoclaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `sudoclaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. SudoClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so SudoClaw can keep replying while a provider is rate-limited.
...
SudoClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. SudoClaw fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `sudoclaw.json`.

Steps:

1. Enable the plugin: `sudoclaw plugins enable google-gemini-cli-auth`
2. Login: `sudoclaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. SudoClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. SudoClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run SudoClaw can I connect it to my MacBook Pro
...
- Use `sudoclaw nodes status` / `sudoclaw nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but SudoClaw authorization uses numeric IDs only.
...
### Can multiple people use one WhatsApp number with different SudoClaw instances
...
If you run SudoClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the SudoClaw code install. Your state
(`~/.sudoclaw`) and workspace (`~/.sudoclaw/workspace`) stay untouched.
...
**SudoClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run SudoClaw on a dedicated machine
...
SudoClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run SudoClaw in a VM and what are the requirements
...
### What is SudoClaw in one paragraph

SudoClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

SudoClaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for SudoClaw
...
### Can SudoClaw help with lead gen outreach ads and blogs for a SaaS
...
SudoClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

SudoClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use SudoClaw when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.sudoclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.sudoprivacy/sudoclaw.json`). Precedence is `<workspace>/skills` > `~/.sudoclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.sudoprivacy/sudoclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.sudoclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which SudoClaw treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `SUDOCLAW_SKIP_CRON` is not set.
...
```bash
sudoclaw cron run <jobId> --force
sudoclaw cron runs --id <jobId> --limit 50
```
...
### Can SudoClaw run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.sudoclaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-sudoclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. SudoClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.sudoclaw/skills`) to allow Linux:
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured SudoClaw workspace); SudoClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.sudoclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `SUDOCLAW_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `SUDOCLAW_DOCKER_APT_PACKAGES`.
...
SudoClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

SudoClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, SudoClaw auto-selects a provider when it
...
configured and present, SudoClaw
prefers `local`.
...
### Is all data used with SudoClaw saved locally

No - **SudoClaw's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.sudoclaw` + your workspace directory).
...
### Where does SudoClaw store its data

Everything lives under `$SUDOCLAW_STATE_DIR` (default: `~/.sudoclaw`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$SUDOCLAW_STATE_DIR/sudoclaw.json`                             | Main config (JSON5)                                                |
| `$SUDOCLAW_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$SUDOCLAW_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$SUDOCLAW_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$SUDOCLAW_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$SUDOCLAW_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$SUDOCLAW_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$SUDOCLAW_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$SUDOCLAW_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.sudoclaw/agent/*` (migrated by `sudoclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.sudoclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.sudoclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.sudoclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.sudoclaw/skills`).

Default workspace is `~/.sudoclaw/workspace`, configurable via:
...
Do **not** commit anything under `~/.sudoclaw` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall SudoClaw
...
`workspace` to the repo root. The SudoClaw repo is just source code; keep the
...
SudoClaw reads an optional **JSON5** config from `$SUDOCLAW_CONFIG_PATH` (default: `~/.sudoprivacy/sudoclaw.json`):

```
$SUDOCLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.sudoclaw/workspace`).
...
SudoClaw enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.
...
- Daemons read env vars from `~/.sudoclaw/.env` (or the service environment).
...
### Can the SudoClaw browser run headless
...
- Gateway is running: `sudoclaw gateway status`
- Gateway health: `sudoclaw status`
- Channel health: `sudoclaw channels status`
...
### Can two SudoClaw instances talk to each other local VPS
...
`sudoclaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
sudoclaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.sudoprivacy/sudoclaw.json`).
...
- Use `sudoclaw config set` for small changes.
- Use `sudoclaw configure` for interactive edits.
...
### How does SudoClaw load environment variables

SudoClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.sudoclaw/.env` (aka `$SUDOCLAW_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.sudoclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`SUDOCLAW_LOAD_SHELL_ENV=1`, `SUDOCLAW_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`sudoclaw models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means SudoClaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.sudoclaw/.env`:
...
### Is there a way to make a team of SudoClaw instances one CEO and many agents
...
### How do I completely reset SudoClaw but keep it installed
...
```bash
sudoclaw reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `SUDOCLAW_PROFILE`), reset each state dir (defaults are `~/.sudoclaw-<profile>`).
- Dev reset: `sudoclaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), SudoClaw skips the heartbeat run to save API calls.
...
No. SudoClaw runs on **your own account**, so if you're in the group, SudoClaw can see it.
...
```bash
sudoclaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't SudoClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.sudoclaw/agents/<agentId>/sessions/`.
...
SudoClaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, SudoClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `sudoclaw models set ...` (updates just model config)
- `sudoclaw configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.sudoprivacy/sudoclaw.json`
...
### What do SudoClaw, Flawd, and Krill use for models

- **SudoClaw + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. SudoClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.sudoclaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `sudoclaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so SudoClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.sudoclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.sudoclaw/agent/*` (migrated by `sudoclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.sudoclaw/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `sudoclaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `sudoclaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `sudoclaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.sudoclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    sudoclaw models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), SudoClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: SudoClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
SudoClaw uses provider-prefixed IDs like:
...
SudoClaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `sudoclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
sudoclaw models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
sudoclaw models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
sudoclaw models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
sudoclaw models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

SudoClaw supports both:
...
### Why does sudoclaw gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `sudoclaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does sudoclaw gateway status show Config cli and Config service different
...
SudoClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `sudoclaw gateway --port <port>`.

### How do I run SudoClaw in remote mode client connects to a Gateway elsewhere
...
- `sudoclaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Still stuck? Run `sudoclaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `sudoclaw --profile <name> …` per instance (auto-creates `~/.sudoclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `sudoclaw --profile <name> gateway install`.

Profiles also suffix service names (`ai.sudoclaw.<profile>`; legacy `com.sudoclaw.*`, `sudoclaw-gateway-<profile>.service`, `SudoClaw Gateway (<profile>)`).
...
- macOS: `$SUDOCLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.sudoclaw/logs/...`; profiles use `~/.sudoclaw-<profile>/logs/...`)
- Linux: `journalctl --user -u sudoclaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "SudoClaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `sudoclaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart SudoClaw
...
1. Is the Gateway running? `sudoclaw gateway status`
2. Is the Gateway healthy? `sudoclaw status`
...
```bash
sudoclaw channels status
sudoclaw channels logs --channel telegram
```
...
### ELI5 sudoclaw gateway restart vs sudoclaw gateway

- `sudoclaw gateway restart`: restarts the **background service** (launchd/systemd).
- `sudoclaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `sudoclaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [SudoClaw assistant setup](/start/sudoclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
sudoclaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose SudoClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `sudoclaw pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `sudoclaw pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. SudoClaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
sudoclaw pairing approve whatsapp <code>
```

List pending requests:

```bash
sudoclaw pairing list whatsapp
```
...
SudoClaw blocks **cross-provider** messaging by default. If a tool call is bound
