...
read_when:
  ...
  - Wiring external systems into SudoClaw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your SudoClaw config directory (typically `~/.sudoclaw/hooks/transforms`).
...
- `sudoclaw webhooks gmail setup` writes `hooks.gmail` config for `sudoclaw webhooks gmail run`.
