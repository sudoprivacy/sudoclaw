...
```bash
gog gmail watch status --account sudoclaw@gmail.com
gog gmail history --account sudoclaw@gmail.com --since <historyId>
```
...
```bash
gog gmail watch stop --account sudoclaw@gmail.com
