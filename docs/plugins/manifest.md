...
read_when:
  - You are building a SudoClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (sudoclaw.plugin.json)

Every plugin **must** ship a `sudoclaw.plugin.json` file in the **plugin root**.
SudoClaw uses this manifest to validate configuration **without executing plugin
