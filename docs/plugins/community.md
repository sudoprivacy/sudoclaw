...
read_when:
  - You want to publish a third-party SudoClaw plugin
...
This page tracks high-quality **community-maintained plugins** for SudoClaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `sudoclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `sudoclaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect SudoClaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/sudoclaw-wechat`
  repo: `https://github.com/icesword0760/sudoclaw-wechat`
  install: `sudoclaw plugins install @icesword760/sudoclaw-wechat`
