...
read_when:
  ...
  - Reviewing SudoClaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is SudoClaw’s explicit **owner approval** step.
...
Stored under `~/.sudoclaw/credentials/`:
...
3. On your phone, open the SudoClaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `sudoclaw nodes pending/approve`) is a
