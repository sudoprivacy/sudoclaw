---
summary: "Synology Chat webhook setup and SudoClaw config"
read_when:
  - Setting up Synology Chat with SudoClaw
...
```bash
sudoclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your SudoClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in SudoClaw.
...
- Pairing approvals work with:
  - `sudoclaw pairing list synology-chat`
  - `sudoclaw pairing approve synology-chat <CODE>`
...
```bash
sudoclaw message send --channel synology-chat --target 123456 --text "Hello from SudoClaw"
sudoclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
