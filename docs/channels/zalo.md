...
- Install via CLI: `sudoclaw plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `sudoclaw plugins install ./extensions/zalo`
   - From npm (if published): `sudoclaw plugins install @openclaw/zalo`
...
- Approve via:
  - `sudoclaw pairing list zalo`
  - `sudoclaw pairing approve zalo <CODE>`
...
- Example: `sudoclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `sudoclaw channels status --probe`
