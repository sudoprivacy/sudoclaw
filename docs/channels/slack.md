...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure SudoClaw HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `sudoclaw pairing approve slack <code>`.
...
SudoClaw supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, SudoClaw falls back to normal delivery for remaining payloads.
