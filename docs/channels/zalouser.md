...
read_when:
  - Setting up Zalo Personal for SudoClaw
...
- Install via CLI: `sudoclaw plugins install @sudoclaw/zalouser`
- Or from a source checkout: `sudoclaw plugins install ./extensions/zalouser`
...
- `sudoclaw pairing list zalouser`
- `sudoclaw pairing approve zalouser <code>`
...
- On startup, SudoClaw resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `sudoclaw channels logout --channel zalouser && sudoclaw channels login --channel zalouser`
