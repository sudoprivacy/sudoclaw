---
summary: "Mattermost bot setup and SudoClaw config"
read_when:
...
4. Configure SudoClaw and start the gateway.
...
Use these target formats with `sudoclaw message send` or cron/webhooks:
