...
- 在主机上持久化 `~/.sudoclaw` + `~/.sudoclaw/workspace`（重启/重建后保留）
...
| WhatsApp 会话    | `/home/node/.sudoclaw/`           | 主机卷挂载    | 保留二维码登录              |
