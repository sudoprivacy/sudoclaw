...
- `sudoclaw-canvas://<session>/<path>`

Examples:

- `sudoclaw-canvas://main/` → `<canvasRoot>/main/index.html`
- `sudoclaw-canvas://main/assets/app.css` → `<canvasRoot>/main/assets/app.css`
- `sudoclaw-canvas://main/widgets/todo/` → `<canvasRoot>/main/widgets/todo/index.html`
...
```
http://<gateway-host>:18789/__sudoclaw__/a2ui/
```
...
```js
window.location.href = "sudoclaw://agent?message=Review%20this%20design";
```
