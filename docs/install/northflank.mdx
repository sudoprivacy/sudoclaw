...
Deploy SudoClaw on Northflank with a one-click template and finish setup in your browser.
...
1. Click [Deploy SudoClaw](https://northflank.com/stacks/deploy-sudoclaw) to open the template.
2. Create an [account on Northflank](https://app.northflank.com/signup) if you don’t already have one.
3. Click **Deploy SudoClaw now**.
4. Set the required environment variable: `SETUP_PASSWORD`.
5. Click **Deploy stack** to build and run the SudoClaw template.
6. Wait for the deployment to complete, then click **View resources**.
7. Open the SudoClaw service.
8. Open the public SudoClaw URL and complete setup at `/setup`.
9. Open the Control UI at `/sudoclaw`.

## What you get

- Hosted SudoClaw Gateway + Control UI
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/sudoclaw`
