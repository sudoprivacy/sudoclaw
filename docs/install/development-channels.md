...
SudoClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, SudoClaw also aligns
the install method:
...
When you switch channels with `sudoclaw update`, SudoClaw also syncs plugin sources:
