...
Deploy SudoClaw on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/sudoclaw` — Control UI
...
- `SUDOCLAW_STATE_DIR=/data/.sudoclaw` (recommended)
- `SUDOCLAW_WORKSPACE_DIR=/data/workspace` (recommended)
- `SUDOCLAW_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your SudoClaw state + workspace so you can migrate to another host without losing config or memory.
