---
summary: "Overview of SudoClaw onboarding options and flows"
read_when:
...
SudoClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`sudoclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the SudoClaw app when you want a fully guided setup on macOS. Docs:
