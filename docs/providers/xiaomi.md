---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SudoClaw"
read_when:
  - You want Xiaomi MiMo models in SudoClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SudoClaw uses
