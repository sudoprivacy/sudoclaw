...
You can point SudoClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SudoClaw
...
- [Anthropic provider](/providers/anthropic) - Native SudoClaw integration with Claude setup-token or API keys
