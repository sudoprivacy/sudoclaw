---
summary: "Use NVIDIA's OpenAI-compatible API in SudoClaw"
read_when:
  - You want to use NVIDIA models in SudoClaw
...
sudoclaw onboard --auth-choice skip
sudoclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
