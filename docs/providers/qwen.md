---
summary: "Use Qwen OAuth (free tier) in SudoClaw"
read_when:
  - You want to use Qwen with SudoClaw
...
If you already logged in with the Qwen Code CLI, SudoClaw will sync credentials
