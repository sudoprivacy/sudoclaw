---
summary: "Use Synthetic's Anthropic-compatible API in SudoClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SudoClaw registers it as the
...
Note: SudoClaw's Anthropic client appends `/v1` to the base URL, so use
