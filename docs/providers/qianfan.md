---
summary: "Use Qianfan's unified API to access many models in SudoClaw"
read_when:
...
3. SudoClaw installed on your system
...
4. Copy the API key for use with SudoClaw

## CLI setup

```bash
sudoclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SudoClaw Configuration](/gateway/configuration)
