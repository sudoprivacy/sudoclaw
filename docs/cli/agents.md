...
sudoclaw agents set-identity --agent main --avatar avatars/sudoclaw.png
...
```bash
sudoclaw agents set-identity --agent main --name "SudoClaw" --emoji "🦞" --avatar avatars/sudoclaw.png
```
