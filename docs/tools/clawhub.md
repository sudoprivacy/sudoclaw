...
`clawhub sync` scans your current workdir first. If no skills are found, it falls back to known legacy locations (for example `~/sudoclaw/skills` and `~/.sudoclaw/skills`). This is designed to find older skill installs without extra flags.
