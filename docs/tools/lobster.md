...
Install the Lobster CLI on the **same host** that runs the SudoClaw Gateway (see the [Lobster repo](https://github.com/openclaw/lobster)), and ensure `lobster` is on `PATH`.
