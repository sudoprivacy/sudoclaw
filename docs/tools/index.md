---
summary: "Agent tool surface for SudoClaw (browser, canvas, nodes, message, cron) replacing legacy `openclaw-*` skills"
read_when:
...
- `group:nodes`: `nodes`
- `group:openclaw`: all built-in SudoClaw tools (excludes provider plugins)
