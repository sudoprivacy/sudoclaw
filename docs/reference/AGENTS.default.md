...
- macOS app manages permissions (screen recording, notifications, microphone) and exposes the `sudoclaw` CLI via its bundled binary.
...
- Prefer the `sudoclaw` CLI for scripting; mac app handles permissions.
