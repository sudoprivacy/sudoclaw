...
This document describes how the SudoClaw ACP (Agent Client Protocol) bridge works,
...
SudoClaw Gateway over WebSocket. It keeps ACP session ids mapped to Gateway
...
drive a SudoClaw Gateway session.
