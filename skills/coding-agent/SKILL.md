...
metadata:
  {
    "sudoclaw": { "emoji": "🧩", "requires": { "anyBins": ["claude", "codex", "opencode", "pi"] } },
  }
---
...
**⚠️ CRITICAL: Never review PRs in SudoClaw's own project folder!**
...
9. **NEVER checkout branches in ~/Projects/openclaw/** - that's the LIVE SudoClaw instance!
...
For long-running background tasks, append a wake trigger to your prompt so SudoClaw gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):
