# Contributing to SudoClaw

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/sudoprivacy/sudoclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@sudoclaw](https://x.com/sudoclaw)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/sudoprivacy/sudoclaw/discussions) or ask in Discord first
...
- Test locally with your SudoClaw instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for SudoClaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/sudoprivacy/sudoclaw/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape SudoClaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@sudoclaw.ai with:

- Links to your PRs on SudoClaw (if you don't have any, start there first)
...
- **ClawHub** — [sudoprivacy/clawhub](https://github.com/sudoprivacy/clawhub)
- **Trust and threat model** — [sudoprivacy/trust](https://github.com/sudoprivacy/trust)

For issues that don't fit a specific repo, or if you're unsure, email **security@sudoclaw.ai** and we'll route it.
