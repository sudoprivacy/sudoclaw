...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "sudoclaw-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as SudoClawApp);
      void loadAgents(host as unknown as SudoClawApp);
      void loadToolsCatalog(host as unknown as SudoClawApp);
      void loadNodes(host as unknown as SudoClawApp, { quiet: true });
      void loadDevices(host as unknown as SudoClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as SudoClawApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as SudoClawApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as SudoClawApp);
  }
}
