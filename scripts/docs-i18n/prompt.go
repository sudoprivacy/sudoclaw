...
- Keep product names in English: SudoClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SudoClaw Gateway, use “Gateway 网关”.
