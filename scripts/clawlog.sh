...
show_usage() {
    cat << EOF
clawlog - SudoClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SudoClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SudoClaw logs flow through the macOS unified log (subsystem: ai.sudoclaw).
