...
# Output:
# - dist/SudoClaw.app
# - dist/SudoClaw-<version>.zip
# - dist/SudoClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.sudoclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/SudoClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SudoClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/SudoClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SudoClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SudoClaw-$VERSION.dSYM.zip"
