...
if [[ -z "$version_content" ]]; then
  echo "<h2>SudoClaw $VERSION</h2>"
  echo "<p>Latest SudoClaw update.</p>"
  echo "<p><a href=\"https://github.com/sudoprivacy/sudoclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
