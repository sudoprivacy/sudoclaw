...
export const DEFAULT_SANDBOX_IMAGE = "sudoclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "sudoclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "sudoclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "sudoclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "sudoclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "sudoclaw-sandbox-browser";
