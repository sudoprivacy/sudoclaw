...
function resolveAdaptiveReadMaxBytes(options?: SudoClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSudoClawReadTool(base, {
...
export function createSudoClawReadTool(
  base: AnyAgentTool,
  options?: SudoClawReadToolOptions,
): AnyAgentTool {
