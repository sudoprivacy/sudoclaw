...
function resolveMemoryToolContext(options: { config?: SudoClawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: SudoClawConfig): MemoryCitationsMode {
