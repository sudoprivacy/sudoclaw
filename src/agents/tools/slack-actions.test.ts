...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): SudoClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: SudoClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: SudoClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
