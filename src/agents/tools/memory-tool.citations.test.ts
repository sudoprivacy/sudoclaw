...
function asSudoClawConfig(config: Partial<SudoClawConfig>): SudoClawConfig {
  return config as SudoClawConfig;
}

function createToolConfig() {
  return asSudoClawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: SudoClawConfig = createToolConfig()) {
