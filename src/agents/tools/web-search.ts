...
type WebSearchConfig = NonNullable<SudoClawConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: SudoClawConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("sudoclaw configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.sudoclaw.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://sudoclaw.ai",
          "X-Title": "SudoClaw Web Search",
        },
