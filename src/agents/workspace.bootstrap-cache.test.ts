...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("sudoclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("sudoclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("sudoclaw-cache-test2-");
