...
const CLEANUP_STATE_KEY = Symbol.for("sudoclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("sudoclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("sudoclaw.sessionWriteLockWatchdogState");
