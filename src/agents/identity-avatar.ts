...
function resolveAvatarSource(cfg: SudoClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SudoClawConfig, agentId: string): AgentAvatarResolution {
