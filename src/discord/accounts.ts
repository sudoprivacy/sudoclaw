...
function mergeDiscordAccountConfig(cfg: SudoClawConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: SudoClawConfig): ResolvedDiscordAccount[] {
