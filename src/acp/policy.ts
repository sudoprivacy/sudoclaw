...
export function isAcpEnabledByPolicy(cfg: SudoClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: SudoClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: SudoClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: SudoClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: SudoClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: SudoClawConfig, agentId: string): boolean {
