...
function resolveAnthropicDefaultAuthMode(cfg: SudoClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyTalkApiKey(config: SudoClawConfig): SudoClawConfig {
...
export function applyTalkConfigNormalization(config: SudoClawConfig): SudoClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: SudoClawConfig): SudoClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyLoggingDefaults(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyContextPruningDefaults(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyCompactionDefaults(cfg: SudoClawConfig): SudoClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
