...
export function listBindings(cfg: SudoClawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: SudoClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SudoClawConfig) {
