...
function resolveGatewayPort(cfg: SudoClawConfig, env: NodeJS.ProcessEnv): number {
  const envRaw =
...
function resolveAuth(cfg: SudoClawConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
