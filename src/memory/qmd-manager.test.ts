...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: SudoClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: SudoClawConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__sudoclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__sudoclawMcporterColdStartWarned;
  });
