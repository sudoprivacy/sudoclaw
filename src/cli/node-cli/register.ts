    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "sudoclaw node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["sudoclaw node status", "Check node host service status."],
          ["sudoclaw node install", "Install the node host service."],
          ["sudoclaw node restart", "Restart the installed node host service."],
