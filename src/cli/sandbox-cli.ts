...
const SANDBOX_EXAMPLES = {
  main: [
    ["sudoclaw sandbox list", "List all sandbox containers."],
    ["sudoclaw sandbox list --browser", "List only browser containers."],
    ["sudoclaw sandbox recreate --all", "Recreate all containers."],
    ["sudoclaw sandbox recreate --session main", "Recreate a specific session."],
    ["sudoclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["sudoclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["sudoclaw sandbox list", "List all sandbox containers."],
    ["sudoclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["sudoclaw sandbox recreate --all", "Recreate all containers."],
    ["sudoclaw sandbox recreate --session main", "Recreate a specific session."],
    ["sudoclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["sudoclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["sudoclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["sudoclaw sandbox explain", "Show effective sandbox config."],
    ["sudoclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["sudoclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["sudoclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.sudoclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
