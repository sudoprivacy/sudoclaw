...
${formatHelpExamples([
  ['sudoclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['sudoclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'sudoclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'sudoclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['sudoclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.sudoclaw.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.sudoclaw.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['sudoclaw agents set-identity --agent main --name "SudoClaw" --emoji "🦞"', "Set name + emoji."],
  ["sudoclaw agents set-identity --agent main --avatar avatars/sudoclaw.png", "Set avatar path."],
  [
    "sudoclaw agents set-identity --workspace ~/.sudoclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "sudoclaw agents set-identity --identity-file ~/.sudoclaw/workspace/IDENTITY.md --agent main",
