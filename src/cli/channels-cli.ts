    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["sudoclaw channels list", "List configured channels and auth profiles."],
          ["sudoclaw channels status --probe", "Run channel status checks and probes."],
          [
            "sudoclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["sudoclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.sudoclaw.ai/cli/channels",
        )}\n`,
    );
