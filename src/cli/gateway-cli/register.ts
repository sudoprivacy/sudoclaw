      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["sudoclaw gateway run", "Run the gateway in the foreground."],
            ["sudoclaw gateway status", "Show service status and probe reachability."],
            ["sudoclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["sudoclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.sudoclaw.ai/cli/gateway")}\n`,
      ),
  );
