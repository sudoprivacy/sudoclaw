...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "sudoclaw.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by SudoClaw out-of-band. Treat it as authoritative metadata about the current message context.",
