...
function resolveMentionPatterns(cfg: SudoClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SudoClawConfig | undefined, agentId?: string): RegExp[] {
