...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@sudoclaw", { botUsername: "sudoclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@sudoclaw args", {
        botUsername: "sudoclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@sudoclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "sudoclaw" })).toBe(
      "/help@otherbot",
    );
  });
