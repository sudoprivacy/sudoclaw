...
This directory contains hooks that ship with SudoClaw. These hooks are automatically discovered and can be enabled/disabled via CLI or configuration.
...
Hooks can be configured in `~/.sudoclaw/sudoclaw.json`:
...
Full documentation: https://docs.sudoclaw.ai/automation/hooks
