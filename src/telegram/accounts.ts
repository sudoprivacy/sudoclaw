...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SUDOCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SudoClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SudoClawConfig): string {
...
function mergeTelegramAccountConfig(cfg: SudoClawConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/sudoprivacy/sudoclaw/issues/30673
...
export function listEnabledTelegramAccounts(cfg: SudoClawConfig): ResolvedTelegramAccount[] {
