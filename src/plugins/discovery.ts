...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @sudoclaw/voice-call -> voice-call).
...
export function discoverSudoClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".sudoclaw", "extensions")];
