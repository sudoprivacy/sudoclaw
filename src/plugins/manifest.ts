...
export const PLUGIN_MANIFEST_FILENAME = "sudoclaw.plugin.json";
...
// package.json "sudoclaw" metadata (used for onboarding/catalog)
...
export type SudoClawPackageManifest = {
  extensions?: string[];
...
): SudoClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
