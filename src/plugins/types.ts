...
export type SudoClawPluginConfigSchema = {
...
export type SudoClawPluginToolContext = {
...
export type SudoClawPluginToolFactory = (
  ctx: SudoClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type SudoClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type SudoClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<SudoClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type SudoClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current SudoClaw configuration */
  config: SudoClawConfig;
 ...
 */
export type SudoClawPluginCommandDefinition = {
...
export type SudoClawPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type SudoClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type SudoClawPluginCliContext = {
  program: Command;
  config: SudoClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type SudoClawPluginCliRegistrar = (ctx: SudoClawPluginCliContext) => void | Promise<void>;

export type SudoClawPluginServiceContext = {
  config: SudoClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type SudoClawPluginService = {
  id: string;
  start: (ctx: SudoClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: SudoClawPluginServiceContext) => void | Promise<void>;
};

export type SudoClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type SudoClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: SudoClawPluginConfigSchema;
  register?: (api: SudoClawPluginApi) => void | Promise<void>;
  activate?: (api: SudoClawPluginApi) => void | Promise<void>;
};

export type SudoClawPluginModule =
  | SudoClawPluginDefinition
  | ((api: SudoClawPluginApi) => void | Promise<void>);

export type SudoClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | SudoClawPluginToolFactory,
    opts?: SudoClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: SudoClawPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: SudoClawPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: SudoClawPluginHttpRouteHandler }) => void;
  registerChannel: (registration: SudoClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: SudoClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: SudoClawPluginService) => void;
   ...
   */
  registerCommand: (command: SudoClawPluginCommandDefinition) => void;
