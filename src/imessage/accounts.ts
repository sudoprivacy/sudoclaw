...
function mergeIMessageAccountConfig(cfg: SudoClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: SudoClawConfig): ResolvedIMessageAccount[] {
