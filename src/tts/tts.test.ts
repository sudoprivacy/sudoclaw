...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.SUDOCLAW_TTS_PREFS;
      process.env.SUDOCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.SUDOCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: SudoClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
