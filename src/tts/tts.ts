...
export function resolveTtsConfig(cfg: SudoClawConfig): ResolvedTtsConfig {
...
export function buildTtsSystemPromptHint(cfg: SudoClawConfig): string | undefined {
  ...
  for (const provider of providers) {
    ...
    try {
      if (provider === "edge") {
        ...
        const tempRoot = resolvePreferredSudoClawTmpDir();
