...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SudoClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SudoClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: SudoClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
