...
import type { SudoClawConfig, GatewayBindMode } from "../config/config.js";
...
export async function noteSecurityWarnings(cfg: SudoClawConfig) {
  const warnings: string[] = [];
  const auditHint = `- Run: ${formatCliCommand("sudoclaw security audit --deep")}`;
  ...
  const saferRemoteAccessLines = [
    ...
    "  Docs: https://docs.sudoclaw.ai/gateway/remote",
  ];
