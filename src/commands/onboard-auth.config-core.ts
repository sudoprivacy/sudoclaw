...
export function applyOpenrouterProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: SudoClawConfig): SudoClawConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyMoonshotConfig(cfg: SudoClawConfig): SudoClawConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: SudoClawConfig): SudoClawConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SudoClawConfig): SudoClawConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SudoClawConfig): SudoClawConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: SudoClawConfig): SudoClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SudoClawConfig): SudoClawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: SudoClawConfig): SudoClawConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: SudoClawConfig): SudoClawConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: SudoClawConfig): SudoClawConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: SudoClawConfig): SudoClawConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyQianfanProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: SudoClawConfig): SudoClawConfig {
