...
export function applyOpencodeZenProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyOpencodeZenConfig(cfg: SudoClawConfig): SudoClawConfig {
