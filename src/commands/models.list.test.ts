...
const ensureSudoClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveSudoClawAgentDir = vi.fn().mockReturnValue("/tmp/sudoclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/sudoclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureSudoClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveSudoClawAgentDir,
}));
