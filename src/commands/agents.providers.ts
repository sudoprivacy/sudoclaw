...
function resolveDefaultAccountId(cfg: SudoClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SudoClawConfig): boolean {
...
export function summarizeBindings(cfg: SudoClawConfig, bindings: AgentBinding[]): string[] {
