...
export async function statusCommand(
  ...
  runtime.log(theme.heading("SudoClaw status"));
  runtime.log("");
  ...
  if (pairingRecovery) {
    ...
    if (pairingRecovery.requestId) {
      runtime.log(
        theme.muted(
          `Recovery: ${formatCliCommand(`sudoclaw devices approve ${pairingRecovery.requestId}`)}`,
        ),
      );
    }
    runtime.log(theme.muted(`Fallback: ${formatCliCommand("sudoclaw devices approve --latest")}`));
    runtime.log(theme.muted(`Inspect: ${formatCliCommand("sudoclaw devices list")}`));
  }
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("sudoclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("sudoclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.sudoclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.sudoclaw.ai/troubleshooting");
  runtime.log("");
