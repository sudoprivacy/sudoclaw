...
export function applyVercelAiGatewayProviderConfig(cfg: SudoClawConfig): SudoClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: SudoClawConfig): SudoClawConfig {
