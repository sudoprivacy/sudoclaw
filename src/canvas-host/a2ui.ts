...
export const A2UI_PATH = "/__sudoclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__sudoclaw__/canvas";

export const CANVAS_WS_PATH = "/__sudoclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.sudoclawCanvasA2UIAction.postMessage(...)
  // - Android: window.sudoclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["sudoclawCanvasA2UIAction"];
  ...
  globalThis.SudoClaw = globalThis.SudoClaw ?? {};
  globalThis.SudoClaw.postMessage = postToNode;
  globalThis.SudoClaw.sendUserAction = sendUserAction;
  globalThis.sudoclawPostMessage = postToNode;
  globalThis.sudoclawSendUserAction = sendUserAction;
