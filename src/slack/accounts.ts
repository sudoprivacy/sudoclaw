...
function mergeSlackAccountConfig(cfg: SudoClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SudoClawConfig): ResolvedSlackAccount[] {
