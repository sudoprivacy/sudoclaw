...
export function listWhatsAppAuthDirs(cfg: SudoClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SudoClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SudoClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SudoClawConfig): ResolvedWhatsAppAccount[] {
