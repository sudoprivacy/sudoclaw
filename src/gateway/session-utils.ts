...
import { type SudoClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SudoClawConfig): string[] {
...
export function listAgentsForGateway(cfg: SudoClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SudoClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: SudoClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: SudoClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: SudoClawConfig): GatewaySessionsDefaults {
