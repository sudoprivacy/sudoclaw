...
export function listChannelMessageActions(cfg: SudoClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: SudoClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: SudoClawConfig): boolean {
