...
export type ChannelAgentToolFactory = (params: { cfg?: SudoClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SudoClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SudoClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SudoClawConfig }) => boolean;
  supportsCards?: (params: { cfg: SudoClawConfig }) => boolean;
