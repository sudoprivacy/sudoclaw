...
import { discoverSudoClawPlugins } from "../../plugins/discovery.js";
import type { SudoClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SudoClawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SUDOCLAW_PLUGIN_CATALOG_PATHS", "SUDOCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SudoClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SudoClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SudoClawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSudoClawPlugins({ workspaceDir: options.workspaceDir });
