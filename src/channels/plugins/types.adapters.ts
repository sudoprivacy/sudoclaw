...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: SudoClawConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: SudoClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: SudoClawConfig;
    accountId: string;
    enabled: boolean;
  }) => SudoClawConfig;
  deleteAccount?: (params: { cfg: SudoClawConfig; accountId: string }) => SudoClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: SudoClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: SudoClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: SudoClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: SudoClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: SudoClawConfig) => ChannelAccountSnapshot;
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: SudoClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
