...
enum UIStrings {
    static let welcomeTitle = "Welcome to SudoClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "sudoclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: SudoClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g sudoclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SudoClawChatViewModel(
