...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.sudoclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SudoClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__sudoclaw__/a2ui/").absoluteString + "?platform=macos"
    }
