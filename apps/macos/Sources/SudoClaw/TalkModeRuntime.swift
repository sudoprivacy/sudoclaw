...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.sudoclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.sudoclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SudoClawChatMessage] = messages.compactMap { item in
