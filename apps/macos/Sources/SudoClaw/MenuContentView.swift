...
/// Menu contents for the SudoClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About SudoClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "SudoClaw Not Configured"
        case .remote:
            "Remote SudoClaw Active"
        case .local:
            "SudoClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .sudoclawSelectSettingsTab, object: tab)
        }
    }
