...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.sudoclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".sudoclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.sudoclawCommand(
            subcommand: "gateway",
