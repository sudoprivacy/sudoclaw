...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .sudoclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SudoClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SudoClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let sudoclawSelectSettingsTab = Notification.Name("sudoclawSelectSettingsTab")
}
