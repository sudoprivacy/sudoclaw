...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.sudoclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SudoClaw windows, but below the system’s pop-up menus.
