...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SudoClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SudoClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SudoClawConfigFile.loadDict()
            ...
            SudoClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/sudoclaw"
        state.remoteCliPath = ""
        return state
    }
}
