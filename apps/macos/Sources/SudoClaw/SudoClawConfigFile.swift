...
enum SudoClawConfigFile {
    private static let logger = Logger(subsystem: "ai.sudoclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        SudoClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SudoClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-sudoclaw-config-file",
            "event": "config.write",
