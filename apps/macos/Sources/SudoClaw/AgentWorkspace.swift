...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.sudoclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SudoClawConfigFile.defaultWorkspaceURL() }
