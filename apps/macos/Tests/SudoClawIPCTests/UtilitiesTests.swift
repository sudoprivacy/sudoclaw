...
@Suite(.serialized) struct UtilitiesTests {
    ...
    @Test func gatewayEntrypointPrefersDistOverBin() throws {
        ...
        let bin = tmp.appendingPathComponent("bin/sudoclaw.js")
    ...
    @Test func logLocatorPicksNewestLogFile() throws {
        ...
        let older = dir.appendingPathComponent("sudoclaw-old-\(UUID().uuidString).log")
        let newer = dir.appendingPathComponent("sudoclaw-new-\(UUID().uuidString).log")
