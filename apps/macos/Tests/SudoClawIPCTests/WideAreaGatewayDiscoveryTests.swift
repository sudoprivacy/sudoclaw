import Darwin
import Testing
@testable import SudoClawDiscovery
...
struct WideAreaGatewayDiscoveryTests {
    @Test func discoversBeaconFromTailnetDnsSdFallback() {
            ...
            dig: { args, _ in
                ...
                if recordType == "PTR" {
                    if nameserver == "@100.123.224.76" {
                        return "steipetacstudio-gateway._sudoclaw-gw._tcp.sudoclaw.internal.\n"
                    }
                    return ""
                }
                if recordType == "SRV" {
                ...
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (SudoClaw)\" \"gatewayPort=18789\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/sudoclaw/src/entry.ts\""
                }
                return ""
            })
        ...
        let expectedDisplay = "Peter\u{2019}s Mac Studio (SudoClaw)"
        ...
        #expect(beacon.cliPath == "/Users/steipete/sudoclaw/src/entry.ts")
    }
}
