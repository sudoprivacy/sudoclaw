...
@MainActor
public struct SudoClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SudoClawChatViewModel
    ...
    public init(
        viewModel: SudoClawChatViewModel,
    ...
    private var visibleMessages: [SudoClawChatMessage] {
        let base: [SudoClawChatMessage]
    ...
    private func mergeToolResults(in messages: [SudoClawChatMessage]) -> [SudoClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SudoClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SudoClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SudoClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SudoClawChatMessage) -> String {
