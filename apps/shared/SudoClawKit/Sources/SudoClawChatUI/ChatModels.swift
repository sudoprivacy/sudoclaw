...
public typealias SudoClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SudoClawPlatformImage = UIImage
#endif

public struct SudoClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct SudoClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SudoClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SudoClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SudoClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct SudoClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SudoClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SudoClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SudoClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SudoClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SudoClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SudoClawChatMessageContent].self, forKey: .content) {
...
public struct SudoClawChatHistoryPayload: Codable, Sendable {
...
public struct SudoClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SudoClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SudoClawSessionPreviewItem]
}

public struct SudoClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SudoClawSessionPreviewEntry]

    public init(ts: Int, previews: [SudoClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SudoClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SudoClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SudoClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SudoClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SudoClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SudoClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SudoClawPlatformImage?
...
public struct SudoClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
