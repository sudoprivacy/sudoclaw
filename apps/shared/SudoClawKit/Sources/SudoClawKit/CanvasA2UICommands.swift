...
public enum SudoClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct SudoClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SudoClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
