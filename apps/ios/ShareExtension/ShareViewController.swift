...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.sudoclaw.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to SudoClaw", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to SudoClaw gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to SudoClaw.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "SudoClawShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "SudoClaw is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "SudoClaw Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("sudoclaw-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
