...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = SudoClawLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = SudoClawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.sudoclaw.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected SudoClaw agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while SudoClaw is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for SudoClaw. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(SudoClawLocationMode.off.rawValue)
                            Text("While Using").tag(SudoClawLocationMode.whileUsing.rawValue)
                            Text("Always").tag(SudoClawLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while SudoClaw is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("SudoClaw", value: DeviceInfoHelper.sudoClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = SudoClawLocationMode(rawValue: newValue) else { return }
                Task {
