...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.sudoclaw.gateway"
    private static let nodeService = "ai.sudoclaw.node"
    private static let talkService = "ai.sudoclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.sudoclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.sudoclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("sudoclaw-gateway.log")
    }
