...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SudoClawPhotosLatestParams) async throws -> SudoClawPhotosLatestPayload {
        ...
        var results: [SudoClawPhotoPayload] = []
        ...
        return SudoClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SudoClawPhotoPayload
    {
