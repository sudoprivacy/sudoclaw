# SudoClaw iOS (Super Alpha)

NO TEST FLIGHT AVAILABLE AT THIS POINT

This iPhone app is super-alpha and internal-use only. It connects to an SudoClaw Gateway as a `role: node`.
...
- `apps/ios/Sources/SudoClaw.entitlements` sets `aps-environment` to `development`.
