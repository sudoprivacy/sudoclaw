...
7) Canvas host is enabled and reachable from the device (do not run gateway with `SUDOCLAW_SKIP_CANVAS_HOST=1`; startup logs should include `canvas host mounted at .../__openclaw__/`).
