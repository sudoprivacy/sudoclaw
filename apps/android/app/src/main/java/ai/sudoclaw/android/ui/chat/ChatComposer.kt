...
import ai.sudoclaw.android.ui.mobileSurface
import ai.sudoclaw.android.ui.mobileText
import ai.sudoclaw.android.ui.mobileTextSecondary
import ai.sudoclaw.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.sudoclaw.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.sudoclaw.android.ui.mobileFontFamily,
