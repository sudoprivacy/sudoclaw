...
import ai.sudoclaw.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("SudoClaw is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
